...
BRICK_WIDTH = SCREEN_WIDTH / common.W
BRICK_HEIGHT = BRICK_WIDTH//2#50#SCREEN_HEIGHT / common.H

BUILDERS_COLORS = [ "dark orange", "red", "coral3", "maroon1"]#"deep sky blue","cyan","aquamarine", "lawn green", "gold", "dark orange", "red", "coral3", "maroon1"]
...
def draw_brick(x, y, name_of_builder):
    ...
    x_y_start = [(x+1)*BRICK_WIDTH, (y)*BRICK_HEIGHT]
    x_y_end = [(x)*BRICK_WIDTH, (y+1)*BRICK_HEIGHT]
