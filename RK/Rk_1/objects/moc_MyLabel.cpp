...
QT_MOC_LITERAL(1, 8, 18), // "mouseAddPointEvent"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "MyPoint"
QT_MOC_LITERAL(4, 36, 5) // "event"

    },
    "MyLabel\0mouseAddPointEvent\0\0MyPoint\0"
    "event"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseAddPointEvent((*reinterpret_cast< MyPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyLabel::*)(MyPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::mouseAddPointEvent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::mouseAddPointEvent(MyPoint _t1)
{
