/****************************************************************************
** Meta object code from reading C++ file 'MyGraphicsView.hpp'
**
...
#error "The header file 'MyGraphicsView.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 10), // "pressMouse"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12), // "QMouseEvent*"
QT_MOC_LITERAL(4, 40, 5), // "event"
QT_MOC_LITERAL(5, 46, 14) // "slotAlarmTimer"

    },
    "MyGraphicsView\0pressMouse\0\0QMouseEvent*\0"
    "event\0slotAlarmTimer"
};
...
void MyGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pressMouse((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MyGraphicsView::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGraphicsView::pressMouse)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGraphicsView::pressMouse(QMouseEvent * _t1)
{
